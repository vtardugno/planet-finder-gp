...
_spec = importlib.util.spec_from_file_location("functions_nonstat_2", os.path.join(HERE, "functions_nonstat.py"))
...
def build_parser():
    ...
    parser.add_argument("--output-csv", default="results/cv_nonstat_2_results.csv", help="Where to save per-fold CV results")
...
def main():
    ...
    for fold in range(12):
        ...
        fit_plot_name_optim = f"results/optim_fit_plot_nonstat2_{fold}.png"
