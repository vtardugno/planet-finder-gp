...
def build_parser():
    ...
    parser.add_argument("--mu0", type=float, default=0.0, help="Initial covariance-modulation strength (no fit_cycle warm-start source)")
            ...
            for A in A_inits:
                for B in B_inits:
                    ...
                    rot = term.SimpleProductKernel(
                            nonstat=mf.NonStationaryKernel(mf.alpha_cyc, mf.alpha_cyc_grad, mu=args.mu0, b=b0, P=P0, phi=phi0),
